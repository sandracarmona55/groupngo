...
Group.create(date: DateTime.new(2019,12,30,11,30,00), activity_id: act2.id)
Group.create(date: DateTime.new(2019,12,30,15,30,00), activity_id: act2.id)
Group.create(date: DateTime.new(2019,12,30,18,30,00), activity_id: act2.id)
Group.create(date: DateTime.new(2019,12,31,11,30,00), activity_id: act2.id)
Group.create(date: DateTime.new(2019,12,31,15,30,00), activity_id: act2.id)
Group.create(date: DateTime.new(2019,12,31,18,30,00), activity_id: act2.id)
