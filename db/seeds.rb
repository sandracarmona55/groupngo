...
Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,19,11,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,19,15,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,19,18,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,20,11,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,20,15,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,20,18,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,21,11,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,21,15,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,21,18,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,22,11,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,22,15,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,22,18,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,23,11,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,23,15,30,00), activity_id: act1.id)
Group.create(date: DateTime.new(2019,12,23,18,30,00), activity_id: act1.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act2.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act2.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act2.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act3.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act3.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act3.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act4.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act4.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act4.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act5.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act5.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act5.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act6.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act6.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act6.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act7.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act7.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act7.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act8.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act8.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act8.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act9.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act9.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act9.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act10.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act10.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act10.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act11.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act11.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act11.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act12.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act12.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act12.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act13.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act13.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act13.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act14.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act14.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act14.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act15.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act15.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act15.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act16.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act16.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act16.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act17.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act17.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act17.id)

Group.create(date: DateTime.new(2019,12,18,11,30,00), activity_id: act18.id)
Group.create(date: DateTime.new(2019,12,18,15,30,00), activity_id: act18.id)
Group.create(date: DateTime.new(2019,12,18,18,30,00), activity_id: act18.id)
